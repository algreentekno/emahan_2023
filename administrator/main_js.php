...
!function (NioApp, $) {
  ...
  var rdm = $("#rdm").val();
	var jdl_galeri = $("#jdl_galeri").val();
	var id_album = $("#id_album").val();

    NioApp.Dropzone('.upload-zone', {
    url: 'serverside/uploadgaleri.php?rdm='+rdm+'&judul='+jdl_galeri+'&idalbum='+id_album,
	  width: 300,
	  height: 300, 
...
?>   
    NioApp.DataTable('.datatable-init-exportlimbah', {
      responsive: true,
      responsive: {
        details: true
      },
      ...
      "serverSide": true,
      "ajax":{
      url :"serverside/get_datakelembagaanlimbah.php", // json datasource
       type: 'POST',
   ...
   NioApp.DataTable('.datatable-init-exportlimbah', {
    ...
    $('#outlined-select').on('change', function(){
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportlimbah').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
function load_datakab(tahun,kodekota){
   NioApp.DataTable('.datatable-init-exportlimbah', {
    ...
    $('#outlined-select2').on('change', function(){
      var kodekota=document.getElementById("outlined-select1").value;
      var tahun=document.getElementById("outlined-select2").value;
    /* alert(options); */
    $('.datatable-init-exportlimbah').DataTable().destroy();
    if(tahun != '' && kodekota != '') {
...
?>
 NioApp.DataTable('.datatable-init-exportkel', {
      responsive: true,
      responsive: {
        details: true
      },
      ...
      "serverSide": true,
      "ajax":{
      url :"serverside/get_datakelurahan.php", // json datasource
       type: 'POST',
...
?>
    NioApp.DataTable('.datatable-init-exportakseslimbah', {
      responsive: true,
      responsive: {
        details: true
      }, 
      ...
      "serverSide": true,
      "ajax":{
      url :"serverside/get_dataakseslimbah.php", // json datasource
       type: 'POST',
      
       }
    });
    NioApp.DataTable('.datatable-init-exportakseslimbahtarget', {
      responsive: true,
      responsive: {
        details: true
      }, 
      ...
      "serverSide": true,
      "ajax":{
      url :"serverside/get_dataakseslimbahtarget.php", // json datasource
       type: 'POST',
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportakseslimbah').DataTable().destroy();
    $('.datatable-init-exportakseslimbahtarget').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='spaldlimbah'){
    ?>
     NioApp.DataTable('.datatable-init-exportspald', {
          responsive: true,
          responsive: {
            details: true
          },
          ...
          "serverSide": true,
          "ajax":{
          url :"serverside/get_dataspald.php", // json datasource
           type: 'POST',
   ...
   NioApp.DataTable('.datatable-init-exportspald', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportspald').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='ipltlimbah'){
  ?>
  NioApp.DataTable('.datatable-init-exportiplt', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataiplt.php", // json datasource
         type: 'POST',
         }
      });
  ...
  function load_data(tahun){
   NioApp.DataTable('.datatable-init-exportiplt', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportiplt').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='capaianairminum'){
  ?>
   NioApp.DataTable('.datatable-init-exporttarget', {
    "columnDefs": [
                  { orderable: true, className: 'reorder', targets: 0 },
                  { orderable: false, targets: '_all' }
              ],
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataairminumtarget.php", // json datasource
         type: 'POST',
        
         }
      });
      NioApp.DataTable('.datatable-init-exportcapaian', {
        "columnDefs": [
                  { orderable: true, className: 'reorder', targets: 0 },
                  { orderable: false, targets: '_all' }
              ],
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataairminumcapaian.php", // json datasource
         type: 'POST',
...
//============================================================================
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exporttarget').DataTable().destroy();
    $('.datatable-init-exportcapaian').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='spamreg'){
  ?>
   NioApp.DataTable('.datatable-init-exportspamreg', {
        responsive: true,
        responsive: {
          details: true
        },
   ...
   NioApp.DataTable('.datatable-init-exportspamreg', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportspamreg').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='spamkab'){
  ?>
   NioApp.DataTable('.datatable-init-exportspamkab', {
        responsive: true,
        responsive: {
          details: true
        },
   ...
   NioApp.DataTable('.datatable-init-exportspamkab', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportspamkab').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='spamikk'){
  ?>
   NioApp.DataTable('.datatable-init-exportspamikk', {
        responsive: true,
        responsive: {
          details: true
        },
   ...
   NioApp.DataTable('.datatable-init-exportspamikk', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportspamikk').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='spamperdesaan'){
  ?>
   NioApp.DataTable('.datatable-init-exportspamperdesaan', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataspamperdesaan.php", // json datasource
         type: 'POST',
   ...
   NioApp.DataTable('.datatable-init-exportspamperdesaan', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportspamperdesaan').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='rawanair'){
  ?>
   NioApp.DataTable('.datatable-init-exportrawanair', {
        responsive: true,
        responsive: {
          details: true
        },
   ...
   NioApp.DataTable('.datatable-init-exportrawanair', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportrawanair').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='potensiairbaku'){
  ?>
   NioApp.DataTable('.datatable-init-exportpotensiairbaku', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datapotensiairbaku.php", // json datasource
         type: 'POST',
   ...
   NioApp.DataTable('.datatable-init-exportpotensiairbaku', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportpotensiairbaku').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
function load_datakab(tahun,kodekota){
  ...
  ?>
   NioApp.DataTable('.datatable-init-exportkelembagaanairminum', {
        responsive: true,
        responsive: {
          details: true
        },
   ...
   NioApp.DataTable('.datatable-init-exportkelembagaanairminum', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportkelembagaanairminum').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='aksessampah'){
  ?>
   NioApp.DataTable('.datatable-init-exportaksessampahtarget', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataaksessampahtarget.php", // json datasource
         type: 'POST',
        
         }
      });
      NioApp.DataTable('.datatable-init-exportaksessampahcapaian', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataaksessampahcapaian.php", // json datasource
         type: 'POST',
...
function load_data(tahun){
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportaksessampahtarget').DataTable().destroy();
    $('.datatable-init-exportaksessampahcapaian').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='layanantps'){
  ?>
   NioApp.DataTable('.datatable-init-exportlayanantps', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datalayanantps.php", // json datasource
         type: 'POST',
   ...
   NioApp.DataTable('.datatable-init-exportlayanantps', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportlayanantps').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='layanantpst'){
  ?>
   NioApp.DataTable('.datatable-init-exportlayanantpst', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datalayanantpst.php", // json datasource
         type: 'POST',
   ...
   NioApp.DataTable('.datatable-init-exportlayanantpst', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportlayanantpst').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='layanantpa'){
  ?>
   NioApp.DataTable('.datatable-init-exportlayanantpa', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datalayanantpa.php", // json datasource
         type: 'POST',
   ...
   NioApp.DataTable('.datatable-init-exportlayanantpa', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportlayanantpa').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='kelembagaansampah'){
  ?>
   NioApp.DataTable('.datatable-init-exportkelembagaansampah', {
        responsive: true,
        responsive: {
          details: true
        },
   ...
   NioApp.DataTable('.datatable-init-exportkelembagaansampah', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportkelembagaansampah').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
//========================================================================================
elseif ($_GET['module']=='kawasankumuh'){
  ?>
   NioApp.DataTable('.datatable-init-exportkumuh', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datakumuh.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='kawasankumuhdiatas10ha'){
  ?>
   NioApp.DataTable('.datatable-init-exportkumuhdiatas10ha', {
        responsive: true,
        responsive: {
          details: true
        },
   ...
   NioApp.DataTable('.datatable-init-exportkumuhdiatas10ha', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportkumuhdiatas10ha').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='kawasankumuhdibawah10ha'){
  ?>
   NioApp.DataTable('.datatable-init-exportkumuhdibawah10ha', {
        responsive: true,
        responsive: {
          details: true
        },
   ...
   NioApp.DataTable('.datatable-init-exportkumuhdibawah10ha', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportkumuhdibawah10ha').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='perumahan'){
  ?>
   NioApp.DataTable('.datatable-init-exportperumahan', {
    "columnDefs": [
                  { orderable: true, className: 'reorder', targets: 0 },
                  { orderable: false, targets: '_all' }
              ],
   ...
   NioApp.DataTable('.datatable-init-exportperumahan', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportperumahan').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='rtlh'){
  ?>
   NioApp.DataTable('.datatable-init-exportrtlh', {
    responsive: true,
        responsive: {
          details: true
        }, "columnDefs": [
   ...
   NioApp.DataTable('.datatable-init-exportrtlh', {
    ...
    var tahun = $(this).val();
    /* alert(options); */
    $('.datatable-init-exportrtlh').DataTable().destroy();
    if(tahun != '') {
        load_data(tahun);
    }else{
        load_data();
...
elseif ($_GET['module']=='kab'){
  ?>
   NioApp.DataTable('.datatable-init-exportkab', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datakab.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='kec'){
  ?>
   NioApp.DataTable('.datatable-init-exportkec', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datakec.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='identitas'){
  ?>
   NioApp.DataTable('.datatable-init-exportidentitas', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataidentitas.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='informasi'){
  ?>
   NioApp.DataTable('.datatable-init-exportinformasi', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datainformasi.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='halaman'){
  ?>
   NioApp.DataTable('.datatable-init-exporthalaman', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datahalaman.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='galeri'){
  ?>
   NioApp.DataTable('.datatable-init-exportgaleri', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datagaleri.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='download'){
  ?>
   NioApp.DataTable('.datatable-init-exportdownload', {
    responsive: true,
        responsive: {
          details: true
        },
...
elseif ($_GET['module']=='link'){
  ?>
   NioApp.DataTable('.datatable-init-exportlink', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datalink.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='usermanager'){
  ?>
   NioApp.DataTable('.datatable-init-exportusermanager', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datausermanager.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='kategori'){
  ?>
   NioApp.DataTable('.datatable-init-exportkategori', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datakategoriinformasi.php", // json datasource
         type: 'POST',
  ...
  ?>
   NioApp.DataTable('.datatable-init-exportheader', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataheader.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='album'){
  ?>
   NioApp.DataTable('.datatable-init-exportalbum', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataalbum.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='kategoridownload'){
  ?>
   NioApp.DataTable('.datatable-init-exportkategoridownload', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datakategoridownload.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='templatewebsite'){
  ?>
   NioApp.DataTable('.datatable-init-exporttemplate', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datatemplate.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='draftdataver'){
  ?>
   NioApp.DataTable('.datatable-init-exportdraftdata', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datadrafver.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='validasidata'){
  ?>
   NioApp.DataTable('.datatable-init-exportdraftdataval', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datadrafval.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='riwayatkirimpesan'){
  ?>
   NioApp.DataTable('.datatable-init-exportriwayatkirimpesan', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datariwayatpesan.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='pesanmasuk'){
  ?>
   NioApp.DataTable('.datatable-init-exportriwayatkirimpesanval', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datapesanmasukval.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='pesanmasukval'){
  ?>
   NioApp.DataTable('.datatable-init-exportpesanmasukvalidasi', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datariwayatpesanval.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='validasidatacapaian'){
  ?>
   NioApp.DataTable('.datatable-init-capaian1', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataakseslimbahval.php", // json datasource
         type: 'POST',
        
         }
      });
      NioApp.DataTable('.datatable-init-capaian2', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataairminumcapaianval.php", // json datasource
         type: 'POST',
        
         }
      });
      NioApp.DataTable('.datatable-init-capaian3', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataaksessampahcapaianval.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='menu'){
  ?>
   NioApp.DataTable('.datatable-init-exportmenu', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datamenu.php", // json datasource
         type: 'POST',
...
elseif ($_GET['module']=='tahundata'){
  ?>
   NioApp.DataTable('.datatable-init-exporttahundata', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datatahundata.php", // json datasource
         type: 'POST',
...
?>
NioApp.DataTable('.datatable-init-exportakseslimbahtargetprov', {
    responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataakseslimbahtargetprov.php", // json datasource
         type: 'POST',
        
         }
      });
      NioApp.DataTable('.datatable-init-exporttargetprov', {
       responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataairminumtargetprov.php", // json datasource
         type: 'POST',
        
         }
      });
      NioApp.DataTable('.datatable-init-exportaksessampahtargetprov', {
       responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataaksessampahtargetprov.php", // json datasource
         type: 'POST',
...
function load_datakab(tahun,kodekota){
   NioApp.DataTable('.datatable-init-exportakseslimbahtargetprov', {
    ...
    $('#outlined-select12').on('change', function(){
      var kodekota=document.getElementById("outlined-select11").value;
      var tahun=document.getElementById("outlined-select12").value;
    /* alert(options); */
    $('.datatable-init-exportakseslimbahtargetprov').DataTable().destroy();
    if(tahun != '' && kodekota != '') {
      load_datakab(tahun,kodekota);
    }else{
      load_datakab();
...
//===========================================================================
function load_datakab2(tahun,kodekota){
   NioApp.DataTable('.datatable-init-exporttargetprov', {
        responsive: true,
        responsive: {
          details: true
    ...
    $('#outlined-select14').on('change', function(){
      var kodekota=document.getElementById("outlined-select13").value;
      var tahun=document.getElementById("outlined-select14").value;
    /* alert(options); */
    $('.datatable-init-exporttargetprov').DataTable().destroy();
    if(tahun != '' && kodekota != '') {
      load_datakab2(tahun,kodekota);
    }else{
      load_datakab2();
    }
})
//===========================================================================
function load_datakab22(tahun,kodekota){
   NioApp.DataTable('.datatable-init-exportaksessampahtargetprov', {
        responsive: true,
        responsive: {
          details: true
    ...
    $('#outlined-select16').on('change', function(){
      var kodekota=document.getElementById("outlined-select15").value;
      var tahun=document.getElementById("outlined-select16").value;
    /* alert(options); */
    $('.datatable-init-exportaksessampahtargetprov').DataTable().destroy();
    if(tahun != '' && kodekota != '') {
      load_datakab22(tahun,kodekota);
    }else{
      load_datakab22();
    }
})
...
elseif ($_GET['module']=='lihatpendataan'){
  ?>
   NioApp.DataTable('.datatable-init-pendataan', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datapendataan.php", // json datasource
        type: 'POST',
...
//=====================================================================
function load_datakab(tahundata,kodekota,kodekec,kodekel){
   NioApp.DataTable('.datatable-init-pendataan', {
        responsive: true,
        responsive: {
          details: true
    ...
    /* alert(options); */
    $('.datatable-init-pendataan').DataTable().destroy();
    if(tahundata != '' && kodekota != '' && kodekec != '' && kodekel != '') {
      load_datakab(tahundata,kodekota,kodekec,kodekel);
    }else if(tahundata != '' && kodekota != '' && kodekec == '' && kodekel == '') {
      load_datakab(tahundata,kodekota,kodekec,kodekel);
    }else if(tahundata != '' && kodekota != '' && kodekec != '' && kodekel == '') {
      load_datakab(tahundata,kodekota,kodekec,kodekel);
    }else{
...
function load_datanik(nik){
   NioApp.DataTable('.datatable-init-pendataan', {
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datapendataannik.php", // json datasource
         type: 'POST',
         data: {nik:nik}
...
elseif ($_GET['module']=='verifikasi'){
  ?>
   NioApp.DataTable('.datatable-init-verifikasi', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataverifikasi.php", // json datasource
         type: 'POST',
...
function load_datakab(tahundata,kodekota,kodekec,kodekel){
   NioApp.DataTable('.datatable-init-verifikasi', {
    ...
    $('.caridata').click(function(){
      ...
      var tahundata=document.getElementById("tahun_data").value;
    /* alert(options); */
    $('.datatable-init-verifikasi').DataTable().destroy();
    if(tahundata != '' && kodekota != '' && kodekec != '' && kodekel != '') {
      load_datakab(tahundata,kodekota,kodekec,kodekel);
    }else if(tahundata != '' && kodekota != '' && kodekec == '' && kodekel == '') {
      load_datakab(tahundata,kodekota,kodekec,kodekel);
...
elseif ($_GET['module']=='lihatverifikasi'){
  ?>
   NioApp.DataTable('.datatable-init-lihatverifikasi', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datalihatver.php", // json datasource
         type: 'POST',
...
function load_datakab(tahundata,kodekota,kodekec,kodekel){
   NioApp.DataTable('.datatable-init-lihatverifikasi', {
    ...
    $('.caridata').click(function(){
      ...
      var tahundata=document.getElementById("tahun_data").value;
    /* alert(options); */
    $('.datatable-init-lihatverifikasi').DataTable().destroy();
    if(tahundata != '' && kodekota != '' && kodekec != '' && kodekel != '') {
      load_datakab(tahundata,kodekota,kodekec,kodekel);
    }else if(tahundata != '' && kodekota != '' && kodekec == '' && kodekel == '') {
      load_datakab(tahundata,kodekota,kodekec,kodekel);
...
function load_datanik(nik){
   NioApp.DataTable('.datatable-init-lihatverifikasi', {
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datalihatvernik.php", // json datasource
         type: 'POST',
         data: {nik:nik}
...
elseif ($_GET['module']=='lihatpenanganan'){
  ?>
   NioApp.DataTable('.datatable-init-lihatpenanganan', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datalihatpenanganan.php", // json datasource
         type: 'POST',
...
function load_datakab(tahundata,kodekota,kodekec,kodekel){
   NioApp.DataTable('.datatable-init-lihatpenanganan', {
    ...
    $('.caridata').click(function(){
      ...
      var tahundata=document.getElementById("tahun_data").value;
    /* alert(options); */
    $('.datatable-init-lihatpenanganan').DataTable().destroy();
    if(tahundata != '' && kodekota != '' && kodekec != '' && kodekel != '') {
      load_datakab(tahundata,kodekota,kodekec,kodekel);
    }else if(tahundata != '' && kodekota != '' && kodekec == '' && kodekel == '') {
      load_datakab(tahundata,kodekota,kodekec,kodekel);
...
function load_datanik(nik){
   NioApp.DataTable('.datatable-init-lihatpenanganan', {
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datalihatpenanganannik.php", // json datasource
         type: 'POST',
         data: {nik:nik}
...
elseif ($_GET['module']=='penanganan'){
  ?>
   NioApp.DataTable('.datatable-init-penanganan', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datapenanganan.php", // json datasource
         type: 'POST',
...
function load_datakab(tahundata,kodekota,kodekec,kodekel){
   NioApp.DataTable('.datatable-init-penanganan', {
    ...
    $('.caridata').click(function(){
      ...
      var tahundata=document.getElementById("tahun_data").value;
    /* alert(options); */
    $('.datatable-init-penanganan').DataTable().destroy();
    if(tahundata != '' && kodekota != '' && kodekec != '' && kodekel != '') {
      load_datakab(tahundata,kodekota,kodekec,kodekel);
    }else if(tahundata != '' && kodekota != '' && kodekec == '' && kodekel == '') {
      load_datakab(tahundata,kodekota,kodekec,kodekel);
...
?>
 var rdm=document.getElementById("key").value;
 NioApp.DataTable('.datatable-init-uploaddata', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_dataupload.php", // json datasource
         type: 'POST',
         data: { rdm:rdm}
         }
      });
...
elseif($_GET['module']=='draftpendataan'){
  ?>
   ...
   NioApp.DataTable('.datatable-init-draftdata', {
          responsive: true,
          responsive: {
            details: true
          },
          ...
          "serverSide": true,
          "ajax":{
          url :"serverside/get_datadraft.php", // json datasource
           type: 'POST',
  ...
  ?>
 NioApp.DataTable('.datatable-init-lappendataan', {
        responsive: true,
        responsive: {
          details: true
        },
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_lapdatapendataan.php", // json datasource
         type: 'POST',
...
function load_datakab(tahundata,kodekota,kodekec,kodekel){
   NioApp.DataTable('.datatable-init-lappendataan', {
    ...
    $('.caridata').click(function(){
      ...
      var tahundata=document.getElementById("tahun_data").value;
    /* alert(options); */
    $('.datatable-init-lappendataan').DataTable().destroy();
    if(tahundata != '' && kodekota != '' && kodekec != '' && kodekel != '') {
      load_datakab(tahundata,kodekota,kodekec,kodekel);
    }else if(tahundata != '' && kodekota != '' && kodekec == '' && kodekel == '') {
      load_datakab(tahundata,kodekota,kodekec,kodekel);
...
function load_datanik(nik){
   NioApp.DataTable('.datatable-init-lappendataan', {
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_lapdatapendataannik.php", // json datasource
         type: 'POST',
         data: {nik:nik}
 ...
 <?php
  ...
  elseif($_GET['module']=='lapverifikasi'){
    ?>
   NioApp.DataTable('.datatable-init-lapverifikasi', {
          responsive: true,
          responsive: {
            details: true
          },
          ...
          "serverSide": true,
          "ajax":{
          url :"serverside/get_lapverifikasi.php", // json datasource
           type: 'POST',
  ...
  function load_datakab(tahundata,kodekota,kodekec,kodekel){
     NioApp.DataTable('.datatable-init-lapverifikasi', {
      ...
      $('.caridata').click(function(){
        ...
        var tahundata=document.getElementById("tahun_data").value;
      /* alert(options); */
      $('.datatable-init-lapverifikasi').DataTable().destroy();
      if(tahundata != '' && kodekota != '' && kodekec != '' && kodekel != '') {
        load_datakab(tahundata,kodekota,kodekec,kodekel);
      }else if(tahundata != '' && kodekota != '' && kodekec == '' && kodekel == '') {
        load_datakab(tahundata,kodekota,kodekec,kodekel);
  ...
  function load_datanik(nik){
   NioApp.DataTable('.datatable-init-lapverifikasi', {
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_lapverifikasinik.php", // json datasource
         type: 'POST',
         data: {nik:nik}
   ...
   <?php
    ...
    elseif($_GET['module']=='lappenanganan'){
      ?>
     NioApp.DataTable('.datatable-init-lappenanganan', {
            responsive: true,
            responsive: {
              details: true
            },
            ...
            "serverSide": true,
            "ajax":{
            url :"serverside/get_lapdatapenanganan.php", // json datasource
             type: 'POST',
    ...
    function load_datakab(tahundata,kodekota,kodekec,kodekel){
       NioApp.DataTable('.datatable-init-lappenanganan', {
        ...
        $('.caridata').click(function(){
          ...
          var tahundata=document.getElementById("tahun_data").value;
        /* alert(options); */
        $('.datatable-init-lappenanganan').DataTable().destroy();
        if(tahundata != '' && kodekota != '' && kodekec != '' && kodekel != '') {
          load_datakab(tahundata,kodekota,kodekec,kodekel);
        }else if(tahundata != '' && kodekota != '' && kodekec == '' && kodekel == '') {
          load_datakab(tahundata,kodekota,kodekec,kodekel);
   ...
   NioApp.DataTable('.datatable-init-lappenanganan', {
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_lapdatapenanganannik.php", // json datasource
         type: 'POST',
         data: {nik:nik}
...
?>
 NioApp.DataTable('.datatable-init-lapmilik', {
            responsive: true,
            responsive: {
              details: true
            },
            ...
            "serverSide": true,
            "ajax":{
            url :"serverside/get_lapdatamilik.php", // json datasource
             type: 'POST',
           ...
           //=====================================================================
    function load_datakab(tahundata,kodekota,kodekec,kodekel,milikrumah,miliktanah){
       NioApp.DataTable('.datatable-init-lapmilik', {
            responsive: true,
            responsive: {
              details: true
            ...
            url :"serverside/get_lapdatamilik.php", // json datasource
             type: 'POST',
             data: { tahundata:tahundata,kodekota:kodekota,kodekec:kodekec,kodekel:kodekel,milikrumah:milikrumah,miliktanah:miliktanah }
        ...
        $('.caridata').click(function(){
          ...
          var kodekel=document.getElementById("kode_kel").value;
          var tahundata=document.getElementById("tahun_data").value;
          var milikrumah=document.getElementById("sts_kepemilikan_rumah").value;
          var miliktanah=document.getElementById("sts_kepemilikan_tanah").value;
        /* alert(options); */
        $('.datatable-init-lapmilik').DataTable().destroy();
        if(tahundata != '' && kodekota != '' && kodekec != '' && kodekel != '') {
          load_datakab(tahundata,kodekota,kodekec,kodekel,milikrumah,miliktanah);
        }else if(tahundata != '' && kodekota != '' && kodekec == '' && kodekel == '') {
          load_datakab(tahundata,kodekota,kodekec,kodekel,milikrumah,miliktanah);
        }else if(tahundata != '' && kodekota != '' && kodekec != '' && kodekel == '') {
          load_datakab(tahundata,kodekota,kodekec,kodekel,milikrumah,miliktanah);
   ...
   NioApp.DataTable('.datatable-init-lapmilik', {
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_lapdatamiliknik.php", // json datasource
         type: 'POST',
         data: {nik:nik}
...
elseif ($_GET['module']=='uploadbuktidukung'){
  ?>
   NioApp.DataTable('.datatable-init-lihatpenanganan', {
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datalihatpenangananbukti.php", // json datasource
         type: 'POST',
...
function load_datanik(nik){
   NioApp.DataTable('.datatable-init-lihatpenanganan', {
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datalihatpenanganannikbukti.php", // json datasource
         type: 'POST',
         data: {nik:nik}
  ...
  ?>
   NioApp.DataTable('.datatable-init-lihatpenanganan', {
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datalihatpenangananbukti2.php", // json datasource
         type: 'POST',
...
function load_datanik(nik){
   NioApp.DataTable('.datatable-init-lihatpenanganan', {
        ...
        "serverSide": true,
        "ajax":{
        url :"serverside/get_datalihatpenanganannikbukti2.php", // json datasource
         type: 'POST',
         data: {nik:nik}
