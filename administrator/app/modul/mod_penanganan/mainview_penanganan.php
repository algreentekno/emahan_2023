<div class="nk-content nk-content-fluid">
                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <div class="nk-block-des text-soft">
                                            <p><div class="nk-block-head-sub" style="color: black;"><a class="back-to" href="dashboard"><em class="icon ni ni-arrow-left"></em><span>Dashboard</span></a><a class="back-to" href="#"><em class="icon ni ni-arrow-left"></em><span>Input Penanganan</span></a></div></p>
                                        </div>
    ...
    <strong>Keyword Pencarian : </strong> Silahkan gunakan NIK atau Nama Kepala Keluarga. 
                                        ...
                                        <table width="100%" class="datatable-init-penanganan nowrap greyGridTable" data-export-title="Export">
                                            <thead>
                                                    <tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Penanganan Pendataan</h5>
            </div>
