...
<div class="modal fade zoom" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1" id="modallihatbukti">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <a href="#" class="close" data-bs-dismiss="modal" aria-label="Close">
                <em class="icon ni ni-cross"></em>
            ...
            <div class="modal-header">
                <h5 class="modal-title">Lihat Bukti Dukung Penanganan</h5>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer bg-light">
                <span class="sub-text"><a href="#" class="btn btn-success" class="close" data-bs-dismiss="modal"><em class="icon ni ni-close"></em> Tutup</a></span>
            </div>
        </div>
    </div>
</div>