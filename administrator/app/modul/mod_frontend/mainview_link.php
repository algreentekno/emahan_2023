                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <div class="nk-block-des text-soft">
                                            <p><div class="nk-block-head-sub" style="color: black;"><a class="back-to" href="dashboard"><em class="icon ni ni-arrow-left"></em><span>Dashboard</span></a><a class="back-to" href="#"><em class="icon ni ni-arrow-left"></em><span>Data Link</span></a></div></p>
                                        </div>
                                ...
                                <div class="nk-block nk-block-lg">
                                    ...
                                    <div class="card card-bordered card-preview">
                                        ...
                                        <div class="table-responsive">
                                            <table width="100%" class="datatable-init-exportlink nowrap greyGridTable" data-export-title="Export">
                                            <thead>
                                                    <tr>
...
<div class="modal fade zoom" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1" id="modaltambah">
    ...
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="nama_link" placeholder="">
    </div>
</div>
<div class="form-group">
