                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <div class="nk-block-des text-soft">
                                            <p><div class="nk-block-head-sub" style="color: black;"><a class="back-to" href="dashboard"><em class="icon ni ni-arrow-left"></em><span>Dashboard</span></a><a class="back-to" href="#"><em class="icon ni ni-arrow-left"></em><span>Berita Dan Informasi</span></a></div></p>
                                        </div>
                                ...
                                <div class="nk-block nk-block-lg">
                                    ...
                                    <div class="card card-bordered card-preview">
                                        ...
                                        <div class="table-responsive">
                                            <table width="100%" class="datatable-init-exportinformasi nowrap greyGridTable" data-export-title="Export">
                                            <thead>
                                                    <tr>
...
<div class="form-group">
    ...
    <div class="form-control-wrap">
    <select class="form-select js-select2" id="id_kategori" data-search="on">
    <option value="">Pilih Kategori</option>
    <?php
    $tampil=mysqli_query($koneksi,"SELECT * FROM kategori order by id_kategori");
    while ($jml=mysqli_fetch_array($tampil)){
    ?>
    <option value="<?php echo $jml['id_kategori'];?>"><?php echo $jml['nama_kategori'];?></option>
    <?php
    }
    ?>    
</select>
...
<div class="form-group">
    ...
    <div class="form-control-wrap">
    <textarea class="form-control textarea" id="isi_berita"></textarea>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="alt_gambar" placeholder="">
    </div>
</div>
<div class="form-group">
    <label class="form-label" for="default-01">Tagging</label>
    <div class="form-control-wrap">
    <select class="form-select js-select2" multiple="multiple" id="tag">
    <?php
    $tampil=mysqli_query($koneksi,"SELECT * FROM taging order by Id_tag");
    while ($jml=mysqli_fetch_array($tampil)){
    ?>
    <option value="<?php echo $jml['nama_tag'];?>"><?php echo $jml['nama_tag'];?></option>
    <?php
    }
    ?>    
</select>
