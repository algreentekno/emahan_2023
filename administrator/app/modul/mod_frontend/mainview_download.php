                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <div class="nk-block-des text-soft">
                                            <p><div class="nk-block-head-sub" style="color: black;"><a class="back-to" href="dashboard"><em class="icon ni ni-arrow-left"></em><span>Dashboard</span></a><a class="back-to" href="#"><em class="icon ni ni-arrow-left"></em><span>Download Data</span></a></div></p>
                                        </div>
                                ...
                                <div class="nk-block nk-block-lg">
                                    ...
                                    <div class="card card-bordered card-preview">
                                        ...
                                        <div class="table-responsive">
                                            <table width="100%" class="datatable-init-exportdownload nowrap greyGridTable" data-export-title="Export">
                                            <thead>
                                            <tr>
...
<div class="form-group">
    ...
    <div class="form-control-wrap">
    <select class="form-select js-select2" id="id_kategoridownload" data-search="on">
    <option value="">Pilih Kategori</option>
    <?php
    $tampil=mysqli_query($koneksi,"SELECT * FROM kategori_download order by id_kategoridownload");
    while ($jml=mysqli_fetch_array($tampil)){
    ?>
    <option value="<?php echo $jml['id_kategoridownload'];?>"><?php echo $jml['nama_kategori'];?></option>
    <?php
    }
    ?>    
</select>
...
<div class="form-group">
    ...
    <div class="form-control-wrap">
    <input type="file" class="form-control" id="nama_file">
    </div>
</div>
</p>
            </div>
