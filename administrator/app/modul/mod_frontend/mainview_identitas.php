                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <div class="nk-block-des text-soft">
                                            <p><div class="nk-block-head-sub" style="color: black;"><a class="back-to" href="dashboard"><em class="icon ni ni-arrow-left"></em><span>Dashboard</span></a><a class="back-to" href="#"><em class="icon ni ni-arrow-left"></em><span>Identitas Website</span></a></div></p>
                                        </div>
                                    ...
                                    <div class="nk-block-head-content">
                                        <div class="toggle-wrap nk-block-tools-toggle">
                                            ...
                                            <div class="toggle-expand-content" data-content="pageMenu">
                                                <?php
                                                $sql1= "SELECT * from identitas order by Id_identitas limit 1"; 
                                                $hasil1 = mysqli_query($koneksi,$sql1);
                                                $dataout=mysqli_num_rows($hasil1);
                                                if($dataout>0){}else{
                                                ?>
                                ...
                                <div class="nk-block nk-block-lg">
                                    ...
                                    <div class="card card-bordered card-preview">
                                        ...
                                        <div class="table-responsive">
                                            <table width="100%" class="datatable-init-exportidentitas nowrap greyGridTable" data-export-title="Export">
                                            <thead>
                                                    <tr>
...
<div class="form-group">
    ...
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="meta_deskripsi">
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="no_telp" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
    </div>
</div>
