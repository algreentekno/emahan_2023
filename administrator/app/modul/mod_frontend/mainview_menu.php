                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <div class="nk-block-des text-soft">
                                            <p><div class="nk-block-head-sub" style="color: black;"><a class="back-to" href="dashboard"><em class="icon ni ni-arrow-left"></em><span>Dashboard</span></a><a class="back-to" href="#"><em class="icon ni ni-arrow-left"></em><span>Menu Website</span></a></div></p>
                                        </div>
                                ...
                                <div class="nk-block nk-block-lg">
                                    ...
                                    <div class="card card-bordered card-preview">
                                        ...
                                        <div class="table-responsive">
                                            <table width="100%" class="datatable-init-exportmenu nowrap greyGridTable" data-export-title="Export">
                                            <thead>
                                                    <tr>
...
<div class="modal fade zoom" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1" id="modaltambah">
    ...
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="nama_menu" placeholder="">
    </div>
</div>
<div class="form-group">
    <label class="form-label" for="default-01">Level Menu</label>
    <div class="form-control-wrap">
    <select class="form-select js-select2" id="id_parent" data-search="on">
    ...
    ?>
    <option value="<?php echo $jml['id_menu'];?>"><?php echo $jml['nama_menu'];?></option>
    <?php
    }
    ?>    
</select>
