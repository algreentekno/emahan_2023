<div class="nk-content nk-content-fluid">
                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <div class="nk-block-des text-soft">
                                            <p><div class="nk-block-head-sub" style="color: black;"><a class="back-to" href="dashboard"><em class="icon ni ni-arrow-left"></em><span>Dashboard</span></a><a class="back-to" href="#"><em class="icon ni ni-arrow-left"></em><span>Lihat Data Pendataan Berdasarkan Kepemilikan</span></a></div></p>
                                        </div>
                                    ...
                                    <div class="card card-bordered card-preview">
                                        <div class="card-inner">
                                         ...
                                         <div class="form-control-wrap mb-3">
                                                                ...
                                                                <label class="form-label-outlined" for="outlined-select"><font color='red'>**</font> FILTER KABUPATEN/KOTA</label>
                                                            </div>
                                                            ...
                                                            <div class="form-control-wrap mb-3">
                                                                ...
                                                                <label class="form-label-outlined" for="outlined-select"><font color='red'>**</font> FILTER KECAMATAN</label>
                                                            </div>
                                                            <div class="form-control-wrap mb-3">
                                                                ...
                                                                <label class="form-label-outlined" for="outlined-select"><font color='red'>**</font> FILTER KELURAHAN</label>
                                                            </div>
                                                            <div class="form-control-wrap mb-3">
                                                                <select class="form-select js-select2" data-ui="md" id="sts_kepemilikan_rumah">
                                                                <option value=""></option>
                                                                <option value="MILIK SENDIRI">MILIK SENDIRI</option>
                                                                        <option value="KONTRAK / SEWA">KONTRAK / SEWA</option>
                                                                        <option value="BUKAN MILIK SENDIRI">BUKAN MILIK SENDIRI</option>
                                                                </select>
                                                                <label class="form-label-outlined" for="outlined-select"><font color='red'>**</font> FILTER STATUS KEPEMILIKAN RUMAH</label>
                                                            </div>
                                                            <div class="form-control-wrap mb-3">
                                                                <select class="form-select js-select2" data-ui="md" id="sts_kepemilikan_tanah">
                                                                <option value=""></option>
                                                                <option value="MILIK SENDIRI">MILIK SENDIRI</option>
                                                                        <option value="BUKAN MILIK SENDIRI">BUKAN MILIK SENDIRI</option>
                                                                ...
                                                                <label class="form-label-outlined" for="outlined-select"><font color='red'>**</font> FILTER STATUS KEPEMILIKAN TANAH</label>
                                                            </div>
                                         ...
                                         <div class="form-control-wrap">
                                                                ...
                                                                <label class="form-label-outlined" for="outlined-select"><font color='red'>**</font> FILTER TAHUN DATA</label>
                                                            </div>
                                                           <br>
                                                            <div class="alert alert-icon alert-danger" role="alert">
    <em class="icon ni ni-alert-circle"></em> 
    <strong> Bertanda bintang tidak boleh kosong.</strong> 
</div>
    ...
    <strong>Keyword Pencarian : </strong> Silahkan gunakan NIK atau Nama Kepala Keluarga. 
                                        ...
                                        <table width="100%" class="datatable-init-lapmilik nowrap greyGridTable" data-export-title="Export">
                                            <thead>
                                                    <tr>
