                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <div class="nk-block-des text-soft">
                                            <p><div class="nk-block-head-sub" style="color: black;"><a class="back-to" href="dashboard"><em class="icon ni ni-arrow-left"></em><span>Dashboard</span></a><a class="back-to" href="#"><em class="icon ni ni-arrow-left"></em><span>Capaian Dan Target Sampah</span></a></div></p>
                                        </div>
...
<div class="tab-content">
    <div class="tab-pane" id="tabItem1">
        <p><div class="table-responsive">
          <table width="100%" class="datatable-init-exportaksessampahtarget nowrap greyGridTable" data-export-title="Export">
            <thead>
              <tr>
    ...
    <div class="tab-pane active" id="tabItem4">
        <p><div class="table-responsive">
          <table width="100%" class="datatable-init-exportaksessampahcapaian nowrap greyGridTable" data-export-title="Export">
            <thead>
              <tr>
                <th>Kota/Kabupaten</th>
                <th>Timbulan Sampah (TON/Tahun)</th>
