                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <div class="nk-block-des text-soft">
                                            <p><div class="nk-block-head-sub" style="color: black;"><a class="back-to" href="dashboard"><em class="icon ni ni-arrow-left"></em><span>Dashboard</span></a><a class="back-to" href="#"><em class="icon ni ni-arrow-left"></em><span>Kawasan Kumuh Diatas 10 Ha</span></a></div></p>
                                        </div>
                                ...
                                <div class="nk-block nk-block-lg">
                                    ...
                                    ?>
                                        <div class="table-responsive">
                                            <table width="100%" class="datatable-init-exportkumuhdiatas10ha nowrap greyGridTable" data-export-title="Export">
                                            <thead>
                                                    <tr>
                                                      ...
                                                      <th rowspan="2">Peta Kawasan Kumuh</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Upload Peta Kawasan Perlokasi</h5>
            </div>
            <div class="modal-body">
                <p><div class="hasil-edit"></div></p>
            </div>
            <div class="modal-footer bg-light">
                <span class="sub-text"><span class="sub-text"><a href="#" class="btn btn-success edit2"><em class="icon ni ni-save"></em> Simpan</a></span>
            </span>
            </div>
        </div>
    </div>
...
<div class="modal fade zoom" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1" id="modalfoto">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Lihat Peta Kawasan</h5>
            </div>
            <div class="modal-body">
