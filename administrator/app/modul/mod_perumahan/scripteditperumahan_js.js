<script>  
 $(document).ready(function(){  
      $('.editfoto').click(function(){  
          ...
          formData.append('Id', $('#Id_perumahan').val());
          
         
                $.ajax({  
                     url:"app/modul/mod_perumahan/main_act.php?module=perumahan&act=edit",  
                     method:"POST",  
                     data:formData,
                     cache: false,
                     processData: false,
                     ...
                     success:function(data){ 
                        ...
                        $('.datatable-init-exportperumahan').DataTable().ajax.reload(); 
