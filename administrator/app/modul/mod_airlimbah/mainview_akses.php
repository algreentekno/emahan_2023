                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <div class="nk-block-des text-soft">
                                            <p><div class="nk-block-head-sub" style="color: black;"><a class="back-to" href="dashboard"><em class="icon ni ni-arrow-left"></em><span>Dashboard</span></a><a class="back-to" href="akseslimbah"><em class="icon ni ni-arrow-left"></em><span>Akses Air Limbah</span></a></div></p>
                                        </div>
...
<div class="tab-content">
    <div class="tab-pane" id="tabItem1">
        <p>
          ...
          <table width="100%" class="datatable-init-exportakseslimbahtarget nowrap greyGridTable" data-export-title="Export">
            <thead>
              <tr>
    ...
    <div class="tab-pane active" id="tabItem4">
        ...
        <table width="100%" class="datatable-init-exportakseslimbah nowrap greyGridTable" data-export-title="Export">
            <thead>
              <tr>
                <th>Kota/Kabupaten</th>
                ...
                <th>Capaiann Akses Aman (KK)</th>
                <th>Capaian Akses Sanitasi Layak Sendiri (KK)</th>
                <th>Capaian Akses Sanitasi Layak - Bersama (KK)</th>
                <th>Capaian Akses Sanitasi Belum Layak (KK)</th>
                <th>Capaian BABS Tertutup (KK)</th>
                <th>Capaian BABS Terbuka (KK)</th>
                <th>Validasi</th>
                <th width="6%"></th>
...
<div class="form-group">
    ...
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="capai1" placeholder="" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
    </div>
</div><div class="form-group">
    ...
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="capai3" placeholder="" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
    </div>
</div><div class="form-group">
    ...
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="capai5" placeholder="" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
    </div>
</div><div class="form-group">
