                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <div class="nk-block-des text-soft">
                                            <p><div class="nk-block-head-sub" style="color: black;"><a class="back-to" href="dashboard"><em class="icon ni ni-arrow-left"></em><span>Dashboard</span></a><a class="back-to" href="#"><em class="icon ni ni-arrow-left"></em><span>SPAM IKK</span></a></div></p>
                                        </div>
                                                        ...
                                                        <div class="drodown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li><a href="spamikkadd"><em class="icon ni ni-note-add-fill-c"></em><span>Tambah Data</span></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </li>
                            ...
                            <div class="nk-block">
                                ...
                                <div class="nk-block nk-block-lg">
                                    ...
                                    ?>      <div class="table-responsive">
                                        <table width="100%" class="datatable-init-exportspamikk nowrap greyGridTable" data-export-title="Export">
                                            <thead>
                                                    <tr>
