                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <div class="nk-block-des text-soft">
                                            <p><div class="nk-block-head-sub" style="color: black;"><a class="back-to" href="dashboard"><em class="icon ni ni-arrow-left"></em><span>DASHBOARD</span></a><a class="back-to" href="#"><em class="icon ni ni-arrow-left"></em><span>FORM INPUT DATA SPALD</span></a></div></p>
                                        </div>
                                    ...
                                    <div class="card card-bordered card-preview">
                                       ...
                                       <form action="#">
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-md btn-warning" style="color: black;"><em class="icon ni ni-save"></em> Simpan Data</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
