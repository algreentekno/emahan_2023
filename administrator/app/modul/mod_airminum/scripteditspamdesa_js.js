<script>  
 $(document).ready(function(){  
      $('.editfoto').click(function(){  
          ...
          formData.append('Id', $('#Id_air_desa').val());
          
         
                $.ajax({  
                     url:"app/modul/mod_airlimbah/main_act.php?module=spamikk&act=edit",  
                     method:"POST",  
                     data:formData,
                     cache: false,
                     processData: false,
                     ...
                     success:function(data){ 
                        ...
                        $('.datatable-init-exportspamperdesaan').DataTable().ajax.reload(); 
