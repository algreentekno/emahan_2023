<div class="nk-content nk-content-fluid">
                                    ...
                                    <div class="card card-bordered card-preview">
                                        <div class="card-inner">
                                         ...
                                         <div class="form-control-wrap">
                                                        ...
                                                        <button class="btn btn-info caridata" style="margin-top: 10px;"><em class="icon ni ni-search"></em> Cari Data</button> <!--<button class="btn btn-info" style="margin-top: 10px;" data-bs-toggle="modal" data-bs-target="#modalnik"><em class="icon ni ni-search"></em> Cari NIK</button>-->
    ...
    <strong>Keyword Pencarian : </strong> Silahkan gunakan NIK atau Nama Kepala Keluarga. 
                                        ...
                                        <table width="100%" class="datatable-init-pendataan nowrap greyGridTable" data-export-title="Export">
                                            <thead>
                                                    <tr>
