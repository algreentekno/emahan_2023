...
$sql = "SELECT a.bukti1,a.bukti2,a.bukti3,a.Id_rtlh,a.tahun_dibantu,a.sumber_dana,a.sts_penanganan,a.tahun_verifikasi,a.sts_verifikasi,d.nama_kota,c.nama_kecamatan,b.nama_kelurahan,a.no_ktp,a.nama_kk,a.luas_rumah,a.alamat_rumah,a.sts_kepemilikan_rumah,a.jenis_kawasan FROM  rtlh a INNER JOIN kelurahan b on a.kode_kel=b.kode_kel INNER JOIN kecamatan c on b.kode_kec=c.kode_kec INNER JOIN kota d on c.kode_kota=d.kode_kota where a.sts_verifikasi='Y' and a.sts_penanganan='Y' and $sqlq and a.tahun_penanganan='$tahundata' order by a.Id_rtlh";
...
if( !empty($requestData['search']['value']) ) {
    ...
    $sql.=" where (a.sts_verifikasi='Y' and a.sts_penanganan='Y' and $sqlq and a.tahun_penanganan='$tahundata' and a.nama_kk LIKE '%".$requestData['search']['value']."%')";// $requestData['search']['value'] contains search parameter
    $sql.=" OR (a.sts_verifikasi='Y' and a.sts_penanganan='Y' and $sqlq and a.tahun_penanganan='$tahundata' and a.no_ktp LIKE '%".$requestData['search']['value']."%')";
    ...
    $sql="SELECT a.bukti1,a.bukti2,a.bukti3,a.Id_rtlh,a.tahun_dibantu,a.sumber_dana,a.sts_penanganan,a.tahun_verifikasi,a.sts_verifikasi,d.nama_kota,c.nama_kecamatan,b.nama_kelurahan,a.no_ktp,a.nama_kk,a.luas_rumah,a.alamat_rumah,a.sts_kepemilikan_rumah,a.jenis_kawasan FROM  rtlh a INNER JOIN kelurahan b on a.kode_kel=b.kode_kel INNER JOIN kecamatan c on b.kode_kec=c.kode_kec INNER JOIN kota d on c.kode_kota=d.kode_kota where a.sts_verifikasi='Y' and a.sts_penanganan='Y' and $sqlq and a.tahun_penanganan='$tahundata'";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    <a href="#" data-bs-toggle="modal" data-bs-target="#modallihatbukti" data-id="'.$row['Id_rtlh'].'" class="btn btn-sm btn-round btn-icon btn-success"><em class="icon ni ni-eye"></em></a>
