...
<div class="form-group">
    ...
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="nama_link1" placeholder="" value="<?php echo $dataout['nama_link'];?>">
    </div>
</div>
<div class="form-group">
    <label class="form-label" for="default-01">URL</label>
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="url1" placeholder="" value="<?php echo $dataout['url'];?>">
    </div>
</div>
