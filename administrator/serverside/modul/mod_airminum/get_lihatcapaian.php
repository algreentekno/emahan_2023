...
<div class="form-group">
    ...
    <label class="form-label" for="default-01">Capaian Akes Layak (KK)</label>
    <div class="form-control-wrap">
    ...
    <label class="form-label" for="default-01">Capaian Jaringan Perpipaan (SR)</label>
    <div class="form-control-wrap">
    ...
    <label class="form-label" for="default-01">Capaian  Jaringan Non Perpipaan (KK)</label>
    <div class="form-control-wrap">
...
<div class="form-group">
    <label class="form-label" for="default-01">Capaian Aman (KK)</label>
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="capai61" value="<?php echo $dataout['capaian_8'];?>" placeholder="" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" readonly>
    </div>
</div>
