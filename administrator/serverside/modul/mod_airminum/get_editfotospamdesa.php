...
$sql1= "SELECT * from air_minum_pedesaan where Id_air_desa='$_POST[Id]'"; 
$hasil1 = mysqli_query($koneksi,$sql1);
$dataout=mysqli_fetch_array($hasil1);
?>
<input type="hidden" class="form-control" id="Id_air_desa" value="<?php echo $dataout['Id_air_desa'];?>" required>
...
document.getElementById('longitude').value = [latLng.lng()]
 ...
 var locations = [
    <?php
$sql_lokasi="select *
from air_minum_pedesaan where Id_air_desa='$_POST[Id]'";
...
?>
['<?php echo $data['Id_air_desa'];?>', '<?php echo $data['latitude'];?>', '<?php echo $data['longitude'];?>'],
<?php
}
?>
];
