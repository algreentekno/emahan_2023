...
?>
<input type="hidden" class="form-control" id="Id_air_kabkota" value="<?php echo $dataout['Id_air_kabkota'];?>" required>
...
document.getElementById('longitude').value = [latLng.lng()]
 ...
 var locations = [
    <?php
$sql_lokasi="select *
from air_minum_kab_kota where Id_air_kabkota='$_POST[Id]'";
...
?>
['<?php echo $data['Id_air_kabkota'];?>', '<?php echo $data['latitude'];?>', '<?php echo $data['longitude'];?>'],
<?php
}
?>
];
