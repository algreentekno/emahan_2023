...
?>
<input type="hidden" class="form-control" id="Id_air_ikk" value="<?php echo $dataout['Id_air_ikk'];?>" required>
...
document.getElementById('longitude').value = [latLng.lng()]
 ...
 var locations = [
    <?php
$sql_lokasi="select *
from air_minum_ikk where Id_air_ikk='$_POST[Id]'";
...
?>
['<?php echo $data['Id_air_ikk'];?>', '<?php echo $data['latitude'];?>', '<?php echo $data['longitude'];?>'],
<?php
}
?>
];
