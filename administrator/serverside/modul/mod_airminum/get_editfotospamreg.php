...
?>
<input type="hidden" class="form-control" id="Id_air_regional" value="<?php echo $dataout['Id_air_regional'];?>" required>
...
document.getElementById('longitude').value = [latLng.lng()]
 ...
 var locations = [
    <?php
$sql_lokasi="select *
from air_minum_regional where Id_air_regional='$_POST[Id]'";
...
?>
['<?php echo $data['Id_air_regional'];?>', '<?php echo $data['latitude'];?>', '<?php echo $data['longitude'];?>'],
<?php
}
?>
];
