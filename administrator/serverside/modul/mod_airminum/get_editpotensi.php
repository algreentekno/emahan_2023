...
<div class="form-group">
    ...
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="nama_sumber_air1" placeholder="" value="<?php echo $dataout['nama_sumber_air'];?>">
    </div>
</div>
<div class="form-group">
    <label class="form-label" for="default-01">Debit Air</label>
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="debit1" placeholder="" value="<?php echo $dataout['debit'];?>">
    </div>
</div>
<div class="form-group">
    <label class="form-label" for="default-01">Foto</label><br>
    <small>Untuk Mengganti Foto Silahkan Upload Foto Baru</small>
    ...
    <div class="form-control-wrap">
    <input type="file" class="form-control" id="foto1" value="">
    </div>
</div>
<div id="map"></div>
<style type="text/css">
...
<div class="form-group">
    ...
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="latitude1" placeholder="" value="<?php echo $dataout['latitude'];?>">
    </div>
</div>
<div class="form-group">
    <label class="form-label" for="default-01">Longitude</label>
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="longitude1" placeholder="" value="<?php echo $dataout['longitude'];?>">
    </div>
</div>
