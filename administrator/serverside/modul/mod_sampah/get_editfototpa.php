...
?>
<input type="hidden" class="form-control" id="Id_sampah_tpa" value="<?php echo $dataout['Id_sampah_tpa'];?>" required>
...
document.getElementById('longitude').value = [latLng.lng()]
 ...
 var locations = [
    <?php
$sql_lokasi="select *
from sampah_layanan_tpa where Id_sampah_tpa='$_POST[Id]'";
...
?>
['<?php echo $data['Id_sampah_tpa'];?>', '<?php echo $data['latitude'];?>', '<?php echo $data['longitude'];?>'],
<?php
}
?>
];
