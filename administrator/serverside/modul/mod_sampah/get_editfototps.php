...
$sql1= "SELECT * from sampah_layanan_tps where Id_sampah_tps='$_POST[Id]'"; 
$hasil1 = mysqli_query($koneksi,$sql1);
$dataout=mysqli_fetch_array($hasil1);
?>
<input type="hidden" class="form-control" id="Id_sampah_tps" value="<?php echo $dataout['Id_sampah_tps'];?>" required>
...
document.getElementById('longitude').value = [latLng.lng()]
 ...
 var locations = [
    <?php
$sql_lokasi="select *
from sampah_layanan_tps where Id_sampah_tps='$_POST[Id]'";
...
?>
['<?php echo $data['Id_sampah_tps'];?>', '<?php echo $data['latitude'];?>', '<?php echo $data['longitude'];?>'],
<?php
}
?>
];
