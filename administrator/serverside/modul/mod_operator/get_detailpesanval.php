...
$sql1= "SELECT * from pesan_validasi a inner join kota b on a.kode_kota=b.kode_kota where a.Id_pesan='$_POST[Id]'"; 
$hasil1 = mysqli_query($koneksi,$sql1);
$row=mysqli_fetch_array($hasil1);

mysqli_query($koneksi,"UPDATE pesan_validasi set baca='1' where Id_pesan='$_POST[Id]'");
