...
<div class="form-group">
    ...
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="nama_lengkap1" placeholder="" value="<?php echo $dataout['nama_lengkap'];?>" readonly>
    </div>
</div>
<div class="form-group">
    <label class="form-label" for="default-01">Email</label>
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="email1" placeholder="" value="<?php echo $dataout['email'];?>" readonly>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="form-control-wrap">
    <select class="form-select" id="blokir1" disabled>
        <?php
        if($dataout['blokir']=='Y'){
       ?>
