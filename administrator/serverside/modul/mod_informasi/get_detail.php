...
<div class="form-group">
    ...
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="youtube1" placeholder="" value="<?php echo $dataout['youtube'];?>" readonly>
    </div>
</div>
<div class="form-group">
    <label class="form-label" for="default-01">Kategori Informasi</label>
    <div class="form-control-wrap">
    <select class="form-select js-select2" id="id_kategori1" data-search="on" disabled>
...
<div class="form-group">
    ...
    <div class="form-control-wrap">
    <textarea class="form-control isi_berita1" id="instance11" cols="50" disabled><?php echo $dataout['isi_berita'];?></textarea>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="form-control-wrap">
        ...
        <input type="text" class="form-control" id="alt_gambar1" placeholder="" value="<?php echo $dataout['alt_gambar'];?>" readonly>
    </div>
</div>
