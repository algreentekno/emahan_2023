...
<div class="form-group">
    ...
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="pembuat1" placeholder="" value="<?php echo $dataout['pembuat'];?>">
    </div>
</div>
<div class="form-group">
    <label class="form-label" for="default-01">Folder</label>
    <div class="form-control-wrap">
        <input type="text" class="form-control" id="folder1" placeholder="" value="<?php echo $dataout['folder'];?>">
    </div>
</div>
