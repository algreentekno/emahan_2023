...
$sql1= "SELECT * from air_limbah_spald where Id_spald='$_POST[Id]'"; 
$hasil1 = mysqli_query($koneksi,$sql1);
$dataout=mysqli_fetch_array($hasil1);
?>
<input type="hidden" class="form-control" id="Id_spald" value="<?php echo $dataout['Id_spald'];?>" required>
...
document.getElementById('longitude').value = [latLng.lng()]
 ...
 var locations = [
    <?php
$sql_lokasi="select *
from air_limbah_spald where Id_spald='$_POST[Id]'";
...
?>
['<?php echo $data['Id_spald'];?>', '<?php echo $data['latitude'];?>', '<?php echo $data['longitude'];?>'],
<?php
}
?>
];
