...
$sql1= "SELECT * from air_limbah_kelembagaan a inner join kota b on a.kode_kota=b.kode_kota where a.Id_kelembagaan='$_POST[Id]'"; 
$hasil1 = mysqli_query($koneksi,$sql1);
$dataout=mysqli_fetch_array($hasil1);
?>
<input type="hidden" class="form-control" id="id_kelembagaan1" value="<?php echo $dataout['Id_kelembagaan'];?>" required>
