...
?>
<input type="hidden" class="form-control" id="Id_kumuh_luas1" value="<?php echo $dataout['Id_kumuh_luas'];?>" required>
...
<div class="form-group">
    ...
    <input type="file" class="form-control" id="files1" value="">
    </div>
</div>
