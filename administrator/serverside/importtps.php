    ...
    include("../app/PHPExcel/PHPExcel/IOFactory.php");
           ...
           {  
                ...
                {  
                    ...
                    $nama_tps = $worksheet->getCellByColumnAndRow(3, $row)->getValue();  
                    $latitude = $worksheet->getCellByColumnAndRow(4, $row)->getValue();
                    $longitude = $worksheet->getCellByColumnAndRow(5, $row)->getValue();
                    $nomor_urut = $worksheet->getCellByColumnAndRow(6, $row)->getValue();
                   
                    mysqli_query($koneksi, "INSERT INTO sampah_layanan_tps_temp (kode_prov
                    ,kode_kota
                    ,kode_kec
                    ,kode_kel
                    ,nama_tps
