...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    if($row['validasi']=='1'){
        ...
        $nestedData[] = '<td><center>
        <a href="#" onclick="myFunctiondelete(\''.$row['rdm'].'\')" class="btn btn-sm btn-round btn-icon btn-warning"><em class="icon ni ni-check-c"></em></a>
        <a href="#" data-bs-toggle="modal" data-bs-target="#modalpesan" data-id="'.$row['rdm'].'" class="btn btn-sm btn-round btn-icon btn-success"><em class="icon ni ni-msg"></em></a>
