...
$sql = "SELECT * FROM  pesan_validasi a inner join kota b on a.kode_kota=b.kode_kota where a.kode_kota='$kota' order by a.Id_pesan";
...
if( !empty($requestData['search']['value']) ) {
    ...
    $sql = "SELECT * FROM  pesan_validasi a inner join kota b on a.kode_kota=b.kode_kota";
    ...
    $sql ="SELECT * ";
    $sql.="FROM pesan_validasi a inner join kota b on a.kode_kota=b.kode_kota where a.kode_kota='$kota'";
