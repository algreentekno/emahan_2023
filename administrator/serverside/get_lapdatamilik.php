...
$milikrumah=$_POST['milikrumah'];
$miliktanah=$_POST['miliktanah'];

if($kodekota!='' AND $kodekec=='' AND $kodekel==''){
    $sqlq="a.kode_kota='$kodekota' and a.sts_kepemilikan_rumah='$milikrumah' and a.sts_kepemilikan_tanah='$miliktanah'";
}elseif($kodekota!='' AND $kodekec!='' AND $kodekel==''){
    $sqlq="a.kode_kota='$kodekota' and a.kode_kec='$kodekec' and a.sts_kepemilikan_rumah='$milikrumah' and a.sts_kepemilikan_tanah='$miliktanah'";
}elseif($kodekota!='' AND $kodekec!='' AND $kodekel!=''){
    $sqlq="a.kode_kota='$kodekota' and a.kode_kec='$kodekec' and a.kode_kel='$kodekel' and a.sts_kepemilikan_rumah='$milikrumah' and a.sts_kepemilikan_tanah='$miliktanah'";
}else{
    $sqlq="a.kode_kota='$kodekota' and a.kode_kec='$kodekec' and a.kode_kel='$kodekel' and a.sts_kepemilikan_rumah='$milikrumah' and a.sts_kepemilikan_tanah='$miliktanah'";
}
?>
...
if( !empty($requestData['search']['value']) ) {
    ...
    $sql="SELECT a.sumber_dana,a.tahun_penanganan,a.sts_penanganan,a.tahun_verifikasi,a.ket_verifikasi,a.sts_verifikasi,a.tahun_input_data,a.jenis_tpa_tinja,a.jenis_kloset,a.jamban,a.jarak_tinja,a.sumber_air_minum,a.jumlah_penghuni,a.material_atap,a.kondisi_atap,a.material_dinding,a.kondisi_dinding,a.material_lantai,a.kondisi_lantai,a.ventilasi,a.jendela,a.sloof,a.material_balok,a.material_plafon,a.material_rangka_atap,a.material_kolom,a.material_pondasi,a.jenis_kawasan,a.sts_kepemilikan_tanah,a.aset_rumah,a.sts_kepemilikan_rumah,a.penghasilan,a.luas_rumah,d.nama_kota,c.nama_kecamatan,b.nama_kelurahan,a.no_ktp,a.nama_kk,a.jenis_kelamin,a.no_hp,a.pekerjaan  FROM  rtlh a INNER JOIN kelurahan b on a.kode_kel=b.kode_kel INNER JOIN kecamatan c on b.kode_kec=c.kode_kec INNER JOIN kota d on c.kode_kota=d.kode_kota where $sqlq and a.tahun_input_data='$tahundata'";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    $nestedData[] = $row["tahun_penanganan"];
