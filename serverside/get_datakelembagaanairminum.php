...
// getting total number records without any search
    ...
    $sql = "SELECT * from air_minum_kelembagaan a inner join kota b on a.kode_kota=b.kode_kota inner join provinsi c on a.kode_prov=c.kode_prov where $filter order by a.Id_air_kelembagaan";
...
if( !empty($requestData['search']['value']) ) {
    ...
    $query=mysqli_query($koneksi, $sql) or die(""); // again run query with limit
        ...
        $sql = "SELECT * ";
        $sql.=" FROM air_minum_kelembagaan a inner join kota b on a.kode_kota=b.kode_kota inner join provinsi c on a.kode_prov=c.kode_prov where $filter";
