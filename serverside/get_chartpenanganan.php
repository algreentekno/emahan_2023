...
if($kodekota!='' and $kodekec=='' and $kodekel==''){
   ...
   while ($rdata=mysqli_fetch_array($hasilmenu2)) {
    ...
    $querymenu22 = "SELECT count(*) as jmlh FROM rtlh where kode_kec='$rdata[kode_kec]' and tahun_penanganan='$tahun' and sts_penanganan='Y'";
...
<?php
   ...
   while ($rdata=mysqli_fetch_array($hasilmenu2)) {
    ...
    $querymenu22 = "SELECT count(*) as jmlh FROM rtlh where kode_kel='$rdata[kode_kel]' and tahun_penanganan='$tahun' and sts_penanganan='Y'";
    $hasilmenu22 = mysqli_query($koneksi,$querymenu22);
    $rdata22=mysqli_fetch_array($hasilmenu22);
...
$querymenu223 = "SELECT count(*) as jmlh FROM rtlh where kode_kel='$kodekel' and tahun_penanganan='$tahun' and sts_kepemilikan_rumah='MILIK SENDIRI' and sts_penanganan='Y'";
$hasilmenu223 = mysqli_query($koneksi,$querymenu223);
$rdata223=mysqli_fetch_array($hasilmenu223);

$querymenu224 = "SELECT count(*) as jmlh FROM rtlh where kode_kel='$kodekel' and tahun_penanganan='$tahun' and sts_kepemilikan_tanah='MILIK SENDIRI' and sts_penanganan='Y'";
