...
var data = [
  ...
  <?php  
          if($kodekota=='18'){
          $querymenu213 = "SELECT DISTINCT tahun_data,kode_kota from air_minum_capaian where validasi='1'  group by tahun_data order by tahun_data ASC";
          }else{
            $querymenu213 = "SELECT DISTINCT tahun_data,kode_kota from air_minum_capaian where validasi='1' and kode_kota='$_POST[kodekota]' group by tahun_data order by tahun_data ASC";
          ...
          while ($rdata13=mysqli_fetch_array($hasilmenu213)) {
            ...
            ,round(sum(b.capaian_1),2) as targetlayak,round(sum(b.capaian_3),2) as targetperpipaan,round(sum(b.capaian_5),2) as targetnonperpipaan,round(sum(b.capaian_7),2) as targetaman
            ,round(sum(((a.capaian_2/a.jum_penduduk_kk)*100)),2) as capaianlayak,round(sum(((a.capaian_4/a.jum_penduduk_kk)*100)),2) as capaianperpipaan,round(sum(((a.capaian_6/a.jum_penduduk_kk)*100)),2) as capaiannonperpipaan,round(sum(((a.capaian_8/a.jum_penduduk_kk)*100)),2) as capaianaman
            from air_minum_capaian a inner join air_minum_capaian_target b on a.kode_kota=b.kode_kota where a.tahun_data='$rdata13[tahun_data]' and a.validasi='1' group by a.tahun_data";
            }else{
                $querymenu212 = "SELECT sum(a.jum_penduduk_kk) as jumpendudukkk,sum(a.jumlah_penduduk_jiwa) as jumpenduduk,sum(a.jumlah_penduduk_pedesaan) as jumpendudukdesa,sum(a.jumlah_penduduk_perkotaan) as jumpendudukkota
                ,round(sum(b.capaian_1),2) as targetlayak,round(sum(b.capaian_3),2) as targetperpipaan,round(sum(b.capaian_5),2) as targetnonperpipaan,round(sum(b.capaian_7),2) as targetaman
                ,round(sum(((a.capaian_2/a.jum_penduduk_kk)*100)),2) as capaianlayak,round(sum(((a.capaian_4/a.jum_penduduk_kk)*100)),2) as capaianperpipaan,round(sum(((a.capaian_6/a.jum_penduduk_kk)*100)),2) as capaiannonperpipaan,round(sum(((a.capaian_8/a.jum_penduduk_kk)*100)),2) as capaianaman
                from air_minum_capaian a inner join air_minum_capaian_target b on a.kode_kota=b.kode_kota where a.tahun_data='$rdata13[tahun_data]' and a.kode_kota='$rdata13[kode_kota]' and a.validasi='1' group by a.kode_kota,a.tahun_data";
          ...
          ?>
             ...
             { device: "perpipaan", tahun: "<?php echo $rdata13['tahun_data'];?>", value: <?php  echo $rdata122['capaianperpipaan'];?> },
  ...
  <?php
          ...
          ?>
             ...
             { device: "perpipaan", tahun: "<?php echo $rdata13['tahun_data'];?>", value: 0 },
...
createSeries("value", "PERPIPAAN", "perpipaan");
...
var data =
{
    ...
    if($kodekota=='18'){
     ...
     while ($rdatanama=mysqli_fetch_array($hasilmenu21nama)) {
        if($kodekota=='18'){
        $querymenu212n = "SELECT sum(a.jum_penduduk_kk) as jumpendudukkk,sum(a.jumlah_penduduk_jiwa) as jumpenduduk,sum(a.jumlah_penduduk_pedesaan) as jumpendudukdesa,sum(a.jumlah_penduduk_perkotaan) as jumpendudukkota
        ,round(sum(b.capaian_1),2) as targetlayak,round(sum(b.capaian_3),2) as targetperpipaan,round(sum(b.capaian_5),2) as targetnonperpipaan,round(sum(b.capaian_7),2) as targetaman
        ,round(sum(((a.capaian_2/a.jum_penduduk_kk)*100)),2) as capaianlayak,round(sum(((a.capaian_4/a.jum_penduduk_kk)*100)),2) as capaianperpipaan,round(sum(((a.capaian_6/a.jum_penduduk_kk)*100)),2) as capaiannonperpipaan,round(sum(((a.capaian_8/a.jum_penduduk_kk)*100)),2) as capaianaman
        from air_minum_capaian a inner join air_minum_capaian_target b on a.kode_kota=b.kode_kota where a.tahun_data='$tahun' and a.kode_kota='$rdatanama[kode_kota]' and a.validasi='1' group by a.tahun_data";
        }else{
            $querymenu212n = "SELECT sum(a.jum_penduduk_kk) as jumpendudukkk,sum(a.jumlah_penduduk_jiwa) as jumpenduduk,sum(a.jumlah_penduduk_pedesaan) as jumpendudukdesa,sum(a.jumlah_penduduk_perkotaan) as jumpendudukkota
            ,round(sum(b.capaian_1),2) as targetlayak,round(sum(b.capaian_3),2) as targetperpipaan,round(sum(b.capaian_5),2) as targetnonperpipaan,round(sum(b.capaian_7),2) as targetaman
            ,round(sum(((a.capaian_2/a.jum_penduduk_kk)*100)),2) as capaianlayak,round(sum(((a.capaian_4/a.jum_penduduk_kk)*100)),2) as capaianperpipaan,round(sum(((a.capaian_6/a.jum_penduduk_kk)*100)),2) as capaiannonperpipaan,round(sum(((a.capaian_8/a.jum_penduduk_kk)*100)),2) as capaianaman
            from air_minum_capaian a inner join air_minum_capaian_target b on a.kode_kota=b.kode_kota where a.tahun_data='$tahun' and a.kode_kota='$rdatanama[kode_kota]' and a.validasi='1' group by a.kode_kota,a.tahun_data";
        ...
        if($kodekota=='18'){
          ...
          $rdata121n=mysqli_fetch_array($hasilmenu2121n);
          if($jumnnnnnt>0){
              $perpipaanbar=$rdata121n['capaianperpipaan'];
          }else{
              $perpipaanbar=0; 
          }
    ?>
   ...
   "Perpipaan": <?php echo $perpipaanbar;?> ,
    },
 <?php
     }
     ?>
