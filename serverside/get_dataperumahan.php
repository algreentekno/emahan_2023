...
// getting total number records without any search
    ...
    $sql = "SELECT * from perumahan a inner join kecamatan d on a.kode_kec=d.kode_kec inner join kelurahan e on a.kode_kel=e.kode_kel inner join kota b on a.kode_kota=b.kode_kota inner join provinsi c on a.kode_prov=c.kode_prov where $filter order by a.Id_perumahan";
...
if( !empty($requestData['search']['value']) ) {
    // if there is a search parameter
        ...
        $sql.=" where ($filter and a.nama LIKE '%".$requestData['search']['value']."%')";
    ...
    $query=mysqli_query($koneksi, $sql) or die(""); // again run query with limit
        ...
        $sql = "SELECT * ";
        $sql.=" from perumahan a inner join kecamatan d on a.kode_kec=d.kode_kec inner join kelurahan e on a.kode_kel=e.kode_kel inner join kota b on a.kode_kota=b.kode_kota inner join provinsi c on a.kode_prov=c.kode_prov where $filter";
