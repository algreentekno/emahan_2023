...
<div class="block-downloads">
	<div class="head-downloads" style="background-color: aqua;">TARGET DAN CAPAIAN PERSAMPAHAN</div>
	<div class="row">
...
<div class="row">
        ...
        <div class="item">
                <div class="stat-box bg-success">
                    <div class="inner">
                        ...
                        <div id="timbulsampah">0</div>
                        </div>
                        <p class="stat-title">JUM TIMBULAN SAMPAH (TON/TAHUN)</p>
                    </div>
        ...
        <div class="item">
                <div class="stat-box bg-success">
                    <div class="inner">
                        <div class="stat-value">
                        <div id="penanganansampah">0</div>
                        </div>
                        <p class="stat-title">PENANGANAN SAMPAH (TON/TAHUN)</p>
                    </div>
        ...
        <div class="item">
                <div class="stat-box bg-success">
                    <div class="inner">
                        <div class="stat-value">
                        <div id="pengurangansampah">0</div>
                        </div>
                        <p class="stat-title">PENGURANGAN SAMPAH (TON/TAHUN)</p>
                    </div>
    ...
    <div class="row">
        ...
        <div class="item">
                <div class="stat-box bg-danger">
                    <div class="inner">
                        <div class="stat-value">
                        <div id="targetpenanganan">0 %</div>
                        </div>
                        <p class="stat-title">TARGET PENANGANAN</p>
                    </div>
                    <div class="icon">
                    <img src="<?php echo "$f[folder]/assets/images/sampah.png";?>" width="100px" height="100px">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="item">
                <div class="stat-box bg-danger">
                    <div class="inner">
                        <div class="stat-value">
                        <div id="targetpengurangan">0 %</div>
                        </div>
                        <p class="stat-title">TARGET PENGURANGAN</p>
                    </div>
                    <div class="icon">
                    <img src="<?php echo "$f[folder]/assets/images/sampah.png";?>" width="100px" height="100px">
                    </div>
    ...
    <div class="row">
        ...
        <div class="item">
                <div class="stat-box bg-warning">
                    <div class="inner">
                        <div class="stat-value">
                        <div id="capaianpenanganan">0 %</div>
                        </div>
                        <p class="stat-title">CAPAIAN PENANGANAN</p>
                    </div>
                    <div class="icon">
                    <img src="<?php echo "$f[folder]/assets/images/sampah.png";?>" width="100px" height="100px">
                    </div>
        ...
        <div class="item">
                <div class="stat-box bg-warning">
                    <div class="inner">
                        <div class="stat-value">
                        <div id="capaianpengurangan">0 %</div>
                        </div>
                        <p class="stat-title">CAPAIAN PENGURANGAN</p>
                    </div>
                    <div class="icon">
                    <img src="<?php echo "$f[folder]/assets/images/sampah.png";?>" width="100px" height="100px">
                    </div>
