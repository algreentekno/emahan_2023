...
<div class="block-downloads">
	<div class="head-downloads" style="background-color: aqua;">TARGET DAN CAPAIAN AIR MINUM</div>
	<div class="row">
    ...
    <div class="row">
        ...
        <div class="item">
                <div class="stat-box bg-danger">
                    <div class="inner">
                        <div class="stat-value">
                        <div id="targetperpipaan">0 %</div>
                        </div>
                        <p class="stat-title">JARINGAN PERPIPAAN</p>
                    </div>
        ...
        <div class="item">
                <div class="stat-box bg-danger">
                    <div class="inner">
                        <div class="stat-value">
                        <div id="targetnonperpipaan">0 %</div>
                        </div>
                        <p class="stat-title">NON JARINGAN PERPIPAAN</p>
                    </div>
  ...
  <div class="row">
        ...
        <div class="item">
                <div class="stat-box bg-warning">
                    <div class="inner">
                        ...
                        <p class="stat-title">REALISASI AIR MINUM LAYAK</p>
                    </div>
        ...
        <div class="item">
                <div class="stat-box bg-warning">
                    <div class="inner">
                        <div class="stat-value">
                        <div id="capaianperpipaan">0 %</div>
                        </div>
                        <p class="stat-title">REALISASI JARINGAN PERPIPAAN</p>
                    </div>
        ...
        <div class="item">
                <div class="stat-box bg-warning">
                    <div class="inner">
                        <div class="stat-value">
                        <div id="capaiannonperpipaan">0 %</div>
                        </div>
                        <p class="stat-title">REALISASI NON JARINGAN PERPIPAAN</p>
                    </div>
        ...
        <div class="item">
                <div class="stat-box bg-warning">
                    <div class="inner">
                        ...
                        <p class="stat-title">REALISASI AIR MINUM AMAN</p>
                    </div>
